...
class MockCoreImpl : public ov::CoreImpl{
public:
    MockCoreImpl(bool isNewAPI = true) : CoreImpl(isNewAPI) {}
    ...
    MOCK_CONST_METHOD1(get_plugin, ov::Plugin(const std::string&));
    ~MockCoreImpl() = default;
};
